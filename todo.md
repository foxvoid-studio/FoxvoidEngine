...
- [x] Help Tooltips (`__tooltips__`): Display descriptive text when hovering over variables in the UI, allowing you to quickly remember what a specific variable does without having to open the source code.
